    ...
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <section className="relative bg-brand-600 px-4 py-16 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-brand-100 max-w-2xl mx-auto font-medium">
            Organizações comprometidas com o resgate, cuidado e adoção responsável de pets. Escolha uma parceira e comece sua jornada.
          </p>
        </div>
      </section>
      ...
      {!loading && !error && ongs.length === 0 && (
        <div className="py-20 text-center">
          ...
          <p className="text-slate-600 text-lg">Nenhuma ONG cadastrada ainda.</p>
        </div>
      )}
        ...
        <>
          <div className="mb-8">
            ...
            <p className="text-slate-500">
              Total de {ongs.length} organização{ongs.length !== 1 ? "s" : ""} disponível{ongs.length !== 1 ? "s" : ""}
            </p>
          </div>
          ...
          <section className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {ongs.map((ong) => (
              <article
                key={ong.id}
                className="group flex flex-col overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-100 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:ring-brand-200"
              >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wide">CNPJ</p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wide">Localização</p>
                    ...
                    <div className="flex items-start gap-3">
                      <Phone size={18} className="text-brand-600 mt-0.5 flex-shrink-0" />
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-wide">Contato</p>
                        <p className="text-sm font-semibold text-slate-800">
                    ...
                    {ong.email && (
                      <div className="flex items-start gap-3">
                        <Mail size={18} className="text-brand-600 mt-0.5 flex-shrink-0" />
                        <div className="flex-1 min-w-0">
